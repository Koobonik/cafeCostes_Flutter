                  ...
                  shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(15.0)),
                    ...
                    onPressed: () async {
                      ...
                      if(reply2 == "true"){
                        ...
                        Map map = { "partner_user_id" : "${userinfo.userName}" , "item_name" : orderAndCoupon, "total_amount" : (DetailMenu.money + DetailMenu.shotMoney + DetailMenu.sizeMoney) * DetailMenu.number};
                        ...
                        print(reply);
                        if(reply == null || reply == ""){
                          showToast("해당 쿠폰은 사용하실 수 없습니다.", gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
                          return ;
                        }
